...
class Rencontre
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity=Club::class, inversedBy="rencontresClub1")
     */
    private $club1;

    /**
     * @ORM\ManyToOne(targetEntity=Club::class, inversedBy="rencontresClub2")
     */
    private $club2;
    ...
    public function addStatistiquematch(Statistiquesmatch $statistiquesmatch): self
    {
    ...
    public function removeStatistiquematch(Statistiquesmatch $statistiquesmatch): self
    {
