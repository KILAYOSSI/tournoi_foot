...
use App\Form\StatistiquesmatchType;
...
class AdminStatistiqueController extends AbstractController
{
     ...
     */
    public function index(StatistiquesmatchRepository $statistiqueRepository): Response
    {
    ...
    {
        $statistique = new Statistiquesmatch();
        $form = $this->createForm(StatistiquesmatchType::class, $statistique);
    ...
    {
        $statistique = $doctrine->getRepository(Statistiquesmatch::class)->find($id);
