...
class StatistiquesController extends AbstractController
{
    ...
    public function index(): Response
    {
        ...
        $joueursStats = $this->getDoctrine()->getRepository(\App\Entity\Statistiquematch::class)->createQueryBuilder('s')
            ->select('IDENTITY(s.joueur) as joueurId, SUM(s.buts) as totalButs, SUM(s.passes) as totalPasses, SUM(s.cartons_jaunes) as totalCartonsJaunes, SUM(s.cartons_rouges) as totalCartonsRouges')
            ->groupBy('s.joueur')
